...
//    I2C_SCK_config();
//    I2C_SDA_config();
    P06_OpenDrain_Mode;					// Modify SCL pin to Open drain mode. don't forget the pull high resister in circuit
	P07_OpenDrain_Mode;					// Modify SDA pin to Open drain mode. don't forget the pull high resister in circuit
...
void I2C_delay(void)
{
	Delay(15);//I2C总线时钟频率400k，操作间隔2.5us以上
}
